...
def get_vp_inliers(image, sigma, iterations, line_len, line_gap, threshold):
...
def get_vanishing_point(image, sigma=5, iterations=3000, line_len=7, line_gap=7, threshold=2):
    if image is None:
        raise ValueError('Image is None')

    inlier_lines_list, hypothesis_list, viz_stuff = get_vp_inliers(image, sigma, iterations, line_len, line_gap, threshold)
    image, edges, lines = viz_stuff
    best_hypothesis_1, best_hypothesis_2, best_hypothesis_3 = hypothesis_list

    return inlier_lines_list, best_hypothesis_1, best_hypothesis_2, best_hypothesis_3, edges, lines
